...
public class LoginActivity extends FragmentActivity {
  ...
  private static final String LOGGED_USER_INGO =
...
//                            DialogUtils.showSearchResultDialog(LoginActivity.this, searchContent,
//                                baseUrl, web);
                            return;
                          }
                        }
    ...
    mNextQuestion.setOnClickListener(new OnClickListener() {
      ...
      public void onClick(View arg0) {
        Apis.getNextQuestion(LoginActivity.this, 0, new ApiResponseCallback<QuestionResponse>() {
