...
public class DailyEventCompletedActivity extends BaseActivity implements
	...
	protected void onCreate(Bundle arg0) {
		...
		String shareEnabled = MobclickAgent.getConfigParams(this,
				"share_enabled");
				...
				mLogin.post(new Runnable() {
					...
					public void run() {
						...
						Apis.answer(
								...
								Variables.daliyFeatureFlag, null);
						initLoggedArea(null);
	...
	public void onClick(View v) {
		if (v == mLogin) {
			...
			mShareDialog = new CommonShareDialog(this, getResources()
					.getString(R.string.share_content), null, getResources()
					.getString(R.string.share_add_5_point));
			mShareDialog
