...
public class RankActivity extends BaseActivity {
  ...
  private ApiResponseCallback<UserRankResponse> mUserRankCallback =
      new ApiResponseCallback<UserRankResponse>() {
  ...
  protected void onCreate(Bundle arg0) {
    ...
    View headerView = LayoutInflater.from(this).inflate(
        R.layout.rank_header, null);
    ((TextView) headerView.findViewById(R.id.ranking))
        .setTypeface(mTypeface);
    ((TextView) headerView.findViewById(R.id.user)).setTypeface(mTypeface);
    ((TextView) headerView.findViewById(R.id.credit))
        .setTypeface(mTypeface);
  ...
  public class RankAdapter extends BaseAdapter {
    ...
    public View getView(int position, View convertView, ViewGroup parent) {
      ...
      if (convertView == null) {
        ...
        convertView = mInflater.inflate(R.layout.rank_item, parent,
            false);
        viewHolder.numberView = (TextView) convertView
            .findViewById(R.id.number);
        viewHolder.usernameView = (TextView) convertView
            .findViewById(R.id.username);
        viewHolder.creditView = (TextView) convertView
      ...
      if (position == 0) {
        ...
        viewHolder.numberView
            .setBackgroundResource(R.drawable.rank_other);
      }
